...
/**
 * CompanyListController implements the CRUD actions for Company model.
 */
class CompanyListController extends Controller
{
    ...
    {   
        ...
        if($request->isAjax){
            ...
            $dataProvider = $searchModel->search(Yii::$app->request->queryParams, $model->fld_sec_reg_no);
    ...
    {
        $searchModel = new TblNegativeListSearch();
        $dataProvider = $searchModel->searchByRecord(Yii::$app->request->queryParams);

        return $this->render('/negative-list/record_list', [
            'searchModel' => $searchModel,
            'dataProvider' => $dataProvider,
        ]);
    }

    public function actionAccreditedMicrofins()
    {
        $searchModel = new CompanySearch();
