                ...
                if(isset($data['post_review_status_id'])){
                    switch($data['post_review_status_id'])
                    {
                        ...
                        case 6: //completed
                                ...
                                if($model != null)
                                {
                                    Yii::$app->db->createCommand('UPDATE tbl_negative_list SET fld_cleared = 1, fld_date_cleared = "'.date('Y-m-d H:i:s').'", fld_remarks = "<br><b>'.date('d F Y').': </b> Post Audit Completed - '.$data['remarks'].'" WHERE fld_neg_id = '. $model->fld_neg_id)->query();
                                }
                                break;
                                return true;
                    }
