...
class User extends ActiveRecord implements IdentityInterface
{
    ...
    public function scenarios()
    {
        return ArrayHelper::merge(
            ...
            [
                ...
                'create' => ['username', 'email', 'password','empid','name','initial','office_id','dept_id'],
                'update' => ['username', 'email', 'password','empid','name','initial','office_id','dept_id'],
    ...
    {
        return [
            [['empid','name','initial','office_id','dept_id'],'required'],
            // username rules
